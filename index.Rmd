...
```
If we don't learn the lessons other countries have, we'll repeat their history. Staying home saves lives.

## Days Since First Onset
While China was the first to get hit by COVID-19, everyone else is actually on a similar growth trajectory (unless we take action #stayhome!).
